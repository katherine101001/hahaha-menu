...
//       descCN: '一次满足所有愿望！含小香肠、Q弹鱼饼、鱼丸、独家卟卟脆(炸腐皮)、鲜嫩腐皮与蟹柳。',
...
//                       <span className="font-bold">{category.noteCN}</span>
//                       <span className="opacity-80 font-serif italic scale-90">{category.noteEN}</span>
//                     </div>
//                   </div>
//                 )}
