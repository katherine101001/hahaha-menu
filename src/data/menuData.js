...
const menuData = {
    ...
    highlights: [
        ...
        },
        {
            id: 'h2',
            nameCN: '娘惹椰浆饭套餐',
            nameEN: 'Nyonya Nasi Lemak',
            descCN: '香浓椰浆饭配搭慢火熬煮的娘惹咖喱，佐以花生、水煮蛋与特制叁巴。',
            descEN: 'Aromatic coconut rice served with peanuts, egg, Nyonya Archar and sambal.',
            price: 17.88,
        ...
        },
        {
            ...
            descCN: '浓郁咖喱汤底加入一片灵魂芝士 (Cheese)，融化后的奶香与咖喱完美融合！配搭嫩滑鸡蛋和小料。',
            descEN: 'Rich curry broth enriched with a slice of melting cheese! Served with tender poached egg.',
            price: 18.88,
    ...
    drinksCategories: [
        ...
        },
        {
            ...
            items: [
                ...
                { nameCN: '茉莉丝绒冷萃', nameEN: 'Jasmine Velvet Cold Brew', priceHot: null, priceCold: 7.90 },
